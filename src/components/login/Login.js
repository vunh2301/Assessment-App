...
function Login(props) {
  ...
  return (
    <div className='flex w-full md:h-[100vh] md:flex-row flex-col-reverse'>
      <div className='flex items-center justify-center flex-1 mx-[15px] md:mx-0 pt-[50px] pb-[80px] md:pt-0 md:pb-0'>
        <form
      ...
      <div className='flex items-center justify-center flex-1 bg-[#f3f5f9]'>
        <img
          className='md:w-auto md:h-auto h-[200px] w-full'
